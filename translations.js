...
const translations = {
    hu: {
        ...
        faq6Q: "Miért lassú vagy miért nem sikerül néha a videógenerálás?",
        faq6A: "A videógenerálás rendkívül erőforrás-igényes folyamat. Nagy szerverterheltség esetén előfordulhat időtúllépés, vagy hogy a rendszer csak egy előnézeti képet ad vissza videó helyett. Ilyenkor javasolt pontosítani a promptot, vagy várni 1-2 percet az újabb próbálkozás előtt.",
        faq7Q: "Mi a teendő, ha a zenei vagy hanggenerálás hibaüzenetet ad?",
        faq7A: "A zenei modellek (pl. Meta MusicGen, Pollinations Audio) elérését befolyásolhatja a szerverek aktuális leterheltsége. Győződj meg róla, hogy a stílust angolul adtad meg, és Hugging Face modell használata esetén érvényes API kulcsot adtál meg.",
    ...
    en: {
        ...
        faq6Q: "Why is video generation slow or failing sometimes?",
        faq6A: "Video generation is an extremely resource-intensive process. High server load may cause timeouts or result in the system returning a preview image instead of a video. In such cases, try refining your prompt or wait 1-2 minutes before trying again.",
        faq7Q: "What should I do if music or audio generation returns an error?",
        faq7A: "The availability of music models (e.g., Meta MusicGen, Pollinations Audio) depends on current server load. Make sure you described the style in English and provided a valid API key when using Hugging Face models.",
    ...
    de: {
        ...
        faq6Q: "Warum ist die Videogenerierung manchmal langsam oder schlägt fehl?",
        faq6A: "Die Videogenerierung ist ein extrem ressourcenintensiver Prozess. Bei hoher Serverauslastung kann es zu Zeitüberschreitungen kommen oder das System gibt nur ein Vorschaubild anstelle eines Videos zurück. In diesem Fall empfiehlt es sich, den Prompt zu verfeinern oder 1–2 Minuten zu warten, bevor Sie es erneut versuchen.",
        faq7Q: "Was tun, wenn die Musik- oder Audio-Generierung eine Fehlermeldung ausgibt?",
        faq7A: "Die Verfügbarkeit von Musikmodellen (z. B. Meta MusicGen, Pollinations Audio) hängt von der aktuellen Serverauslastung ab. Stellen Sie sicher, dass Sie den Stil auf Englisch eingegeben haben und bei Verwendung von Hugging-Face-Modellen einen gültigen API-Schlüssel angegeben haben.",
    ...
    fr: {
        ...
        faq6Q: "Pourquoi la génération de vidéo est-elle lente ou échoue-t-elle parfois ?",
        faq6A: "La génération de vidéo est un processus extrêmement gourmand en ressources. En cas de forte charge du serveur, des dépassements de délai peuvent survenir ou le système peut renvoyer une image d'aperçu au lieu d'une vidéo. Dans ce cas, essayez d'affiner votre prompt ou attendez 1 à 2 minutes avant de réessayer.",
        faq7Q: "Que faire si la génération de musique ou d'audio renvoie une erreur ?",
        faq7A: "La disponibilité des modèles musicaux (ex. Meta MusicGen, Pollinations Audio) dépend de la charge actuelle du serveur. Assurez-vous d'avoir décrit le style en anglais et d'avoir fourni une clé API valide si vous utilisez des modèles Hugging Face.",
    ...
    pl: {
        ...
        faq6Q: "Dlaczego generowanie wideo jest czasami wolne lub kończy się błędem?",
        faq6A: "Generowanie wideo jest procesem niezwykle zasobożernym. Przy dużym obciążeniu serwera mogą wystąpić przekroczenia limitu czasu (timeout) lub system może zwrócić jedynie obraz podglądu zamiast wideo. W takim przypadku zaleca się doprecyzowanie promptu lub odczekanie 1-2 minut przed ponowną próbą.",
        faq7Q: "Co zrobić, jeśli generowanie muzyki lub dźwięku zwraca błąd?",
        faq7A: "Dostępność modeli muzycznych (np. Meta MusicGen, Pollinations Audio) zależy od aktualnego obciążenia serwerów. Upewnij się, że opisujesz styl po angielsku, a w przypadku korzystania z modeli Hugging Face podajesz prawidłowy klucz API.",
    ...
    it: {
        ...
        faq6Q: "Perché la generazione di video è lenta o talvolta fallisce?",
        faq6A: "La generazione di video è un processo ad alta intensità di risorse. In caso di elevato traffico sui server, potrebbero verificarsi timeout o il sistema potrebbe restituire un'immagine di anteprima anziché un video. In questi casi, si consiglia di affinare il prompt o attendere 1-2 minuti prima di riprovare.",
        faq7Q: "Cosa fare se la generazione di musica o audio restituisce un errore?",
        faq7A: "La disponibilità dei modelli musicali (es. Meta MusicGen, Pollinations Audio) dipende dal carico attuale del server. Assicurati di inserire lo stile in inglese e, se utilizzi modelli Hugging Face, di aver inserito una chiave API valida.",
